...
def write_output(df, path):
    ...
    save_data_frame_to_directory(path, df)


print("Split the data into train and test")

parser = argparse.ArgumentParser("split")
parser.add_argument("--transformed_data", type=str, help="transformed taxi data")
...
transformed_df = load_data_frame_from_directory(args.transformed_data).data
