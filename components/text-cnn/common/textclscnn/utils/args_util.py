...
def train_args():
    ...
    parser.add_argument('--train-file', type=str, default='data/IMDB_Dataset_Samples.csv',
                        help='the train file path')
    parser.add_argument('--test-file', type=str, default='data/IMDB_Dataset_Samples.csv',
                        help='the test file path')
    parser.add_argument('--trained-model', type=str, default='debug_out/trained_model/',
                        help='the trained path')
    parser.add_argument('--vocab-path', type=str, default='debug_out/trained_vocab/',
    ...
    parser.add_argument('--true-label-value', type=str, default=None,
                        help='Select the column that contains the label')
...
def predict_args():
    ...
    parser.add_argument('--trained-model', type=str, default='debug_out/trained_model',
                        help='the trained path')
    parser.add_argument('--predict-path', type=str, default="debug_out/word_id.parquet",
                        help='the test dataset path')
    parser.add_argument('--predict-result-path', type=str, default="debug_out/predict_result",
...
def preprocess_args():
    ...
    parser.add_argument('--input-data', type=str, default='data/IMDB_Dataset_Samples.csv',
                        help='the input data path')
    parser.add_argument('--input-vocab', type=str, default='debug_out/trained_vocab/',
                        help='the vocab path')
    parser.add_argument('--output-data', type=str, default='debug_out/word_id.parquet',
